...
plot(c(0,PPi_danish),seq(0,length(PPi_danish)),type="s",xlab="time t",ylab="number of events by time t")
points(PPi_danish, rep(0,length(PPi_danish)),type="p")
lines(PPi_danish, seq(1,length(PPi_danish)),type="h",lty=2)
```
